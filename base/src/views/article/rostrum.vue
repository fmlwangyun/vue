  ...
  <div class="container">
    <!-- <header class="header">
      <x-header class="bg-red" >
        <img class="icon" slot="overwrite-left" src="/vue-mobile/img/home/t-rostrum.svg" alt="">
        <span class="title" slot="overwrite-left">专家讲坛</span>
      </x-header>
    </header> -->
    <section class="main">
      <div>
        ...
        <article-list2  :article-type="articleType"></article-list2>
      </div>
    </section>
  </div>
</template>
...
//      articleList2
    ...
    methods:{
       ...
       * */
      tabClick(index){
        this.$refs['articleList2'].refreshGet();
      }
    }
  }
</script>
